...
GooglePO1 googlePO1= new GooglePO1(driver,describer);
	  ...
	  driver.get(baseUrl + "");String nameParam1 = "John";

    String nameParam3 = "dhanuka";googlePO1.login1( nameParam1 , nameParam3 );

GooglePOManual googlePOManual= new GooglePOManual(driver,describer);

    String nameParam6 = "dhanuka";googlePOManual.loginM( nameParam6 );

googlePO1.login3();

GooglePO2 googlePO2= new GooglePO2(driver,describer);String nameParam4 = "dhanuka";googlePO2.login2( nameParam4 );String nameParam2 = "dhanuka";googlePO2.login2( nameParam2 );

}@Test
public void test2() throws Exception {

GooglePO1 googlePO1= new GooglePO1(driver,describer);String nameParam1 = "John";
...
googlePO1.login3();
    ...
    String nameParam5 = "dhanuka";googlePO1.login4( nameParam4 , nameParam5 );


    String nameParam6 = "dhanuka";
    String nameParam7 = "dhanuka";googlePO1.login1( nameParam6 , nameParam7 );

GooglePO2 googlePO2= new GooglePO2(driver,describer);String nameParam2 = "dhanuka";googlePO2.login2( nameParam2 );
